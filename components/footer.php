                            ...
                            <div class="footer-widget mb-30">
                                ...
                                <div class="footer-link">
                                    ...
                                    <li>
                                        ...
                                        <span><a class="" href="tel:+2347056851445">07056851445</a></span>
                                    </li>
                                    <li>
                                        <i class="icon dripicons-mail"></i>
                                         <span><a href="mailto:info@example.com">elepacksiltd@gmail.com</a><br><a href="mailto:sale@example.com">info@elephantpacksindltd.com</a></span>
                                    </li>
                                    <li>
                                      <i class="fal fa-map-marker-alt"></i>
                                         <span>Ishiowka Umuatugbuoma Akegbe-ugwu Nkanu West, Enugu State, Nigeria.</span>
                                    </li>
                                </ul>
                        ...
                        <div class="col-xl-5 col-lg-5 col-sm-6">
                            <div class="footer-widget mb-30">
                                ...
                                <div class="footer-social">
                                    ...
                                    <a href="mailto:elepacksiltd@gmail.com"><i class="fab fa-google-plus-g"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="copyright-text text-center">
                                <p>&copy; <?= date('Y')?> Elephant Packs Industry Limited.</p>
                            </div>
                        </div>
                    </div>
                </div>
